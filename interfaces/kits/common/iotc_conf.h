...
/* 内存调试时是否释放内存，不释放内存判断重复释放时更加准确，但会导致内存大量泄漏 */
    ...
    #define IOTC_CONF_BUILD_TYPE IOTC_BUILD_TYPE_DEBUG
#endif

#ifndef IOTC_CONF_COAP_DUMP_DEBUG
    #define IOTC_CONF_COAP_DEBUG_DUMP_PACKET 1
#endif
    ...
    #define IOT_CONF_LOG_DEFAULT_LEVEL  IOTC_LOG_LEVEL_MAX
#endif
