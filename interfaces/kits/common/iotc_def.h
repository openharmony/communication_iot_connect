...
typedef enum {
 	IOTC_OH_WIFI_ERRCODE_NONE = 0,
 	IOTC_OH_WIFI_ERRCODE_PWD_ERROR,
 	IOTC_OH_WIFI_ERRCODE_SSID_NOT_FOUND,
 	IOTC_OH_WIFI_ERRCODE_AUTH_FAILED,
 	IOTC_OH_WIFI_ERRCODE_ASSOC_FAILED,
 	IOTC_OH_WIFI_ERRCODE_DHCP_FAILED,
 	IOTC_OH_WIFI_ERRCODE_NETCFG_TIMES_OUT,
 	     
 	IOTC_OH_CLOUD_ERRCODE_DNS_FAILED = 100,
 	IOTC_OH_CLOUD_ERRCODE_CONNECT_SERVER_FAILED,
 	IOTC_OH_CLOUD_ERRCODE_SERVER_CLOSE_SOCKET,
 	IOTC_OH_CLOUD_ERRCODE_LOGIN_FAIL,
 	IOTC_OH_WIFI_ERRCODE_UNKNOWN = 255,
} IotcOhNetCfgReasonCode;
