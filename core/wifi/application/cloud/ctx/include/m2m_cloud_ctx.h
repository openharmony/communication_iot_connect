...
typedef enum {
    ...
    M2M_CLOUD_FSM_STATE_DEV_STATUS_SYNC,
    M2M_CLOUD_FSM_STATE_DEV_STATUS_SYNC_WAIT_RESP,
    M2M_CLOUD_FSM_STATE_ONLINE,
    M2M_CLOUD_FSM_STATE_DELETE,
    M2M_CLOUD_FSM_STATE_GET_AUTHCODE,
    M2M_CLOUD_FSM_STATE_ECO_DEV_INFO_SYNC,
    M2M_CLOUD_FSM_STATE_ECO_DEV_INFO_SYNC_WAIT_RESP,
    M2M_CLOUD_FSM_STATE_ECO_STATE_SYNC,
    M2M_CLOUD_FSM_STATE_ECO_STATE_SYNC_WAIT_RESP,
