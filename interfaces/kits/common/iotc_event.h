...
typedef enum {
    ...
    /**< SPEKE协商 */
    IOTC_BLE_SPEKE_NEGOTIATION_SUCCESS,
    ...
    IOTC_CORE_SLE_EVENT_SSAPC_FIND_STRUCTURE,
    IOTC_CORE_SLE_EVENT_SSAPC_FIND_PROPERTY,
    IOTC_CORE_SLE_EVENT_SSAPC_FIND_STRUCTURE_COMPLETE,
    IOTC_CORE_SLE_EVENT_SSAPC_READ_CFM,
    IOTC_CORE_SLE_EVENT_SSAPC_READ_BY_UUID_COMPLETE,
    IOTC_CORE_SLE_EVENT_SSAPC_WRITE_CFM,
    IOTC_CORE_SLE_EVENT_SSAPC_EXCHANGE_INFO,
    IOTC_CORE_SLE_EVENT_SSAPC_NOTIFICATION,
    IOTC_CORE_SLE_EVENT_SSAPC_INDICATION,
    IOTC_CORE_SLE_EVENT_SPEKE_FINISHED,
    IOTC_CORE_SLE_EVENT_AUTH_SETUP_FINISHED,
    IOTC_EVENT_INNER_CLOUD_SLE_SETUP,
    IOTC_EVENT_INNER_CLOUD_SLE_STATUS_SYNC,
    IOTC_EVENT_INNER_CLOUD_SLE_DEVINFO_SYNC,
    IOTC_CORE_SLE_EVENT_AUTH_CODE_SETUP,
    IOTC_CORE_SLE_EVENT_START_SEEK_SETUP,
    IOTC_EVENT_INNER_CLOUD_SLE_STATUS_RESULT,
